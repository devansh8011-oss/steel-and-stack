  ...
  return (
    <>
      ...
      <Section
        ...
        spacing="compact"
        borderBottom
        className="pt-12 pb-14 border-slate-200/80 relative overflow-hidden"
      >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {SITE_CONFIG.howItWorks.map((step, idx) => (
            <div
              key={step.step}
              className="bg-white p-6 rounded-2xl border border-slate-200/90 shadow-subtle-card hover:border-brand-orange-400 hover:shadow-hover-card relative flex flex-col justify-between transition-all"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl font-black text-brand-orange-600 font-mono">
                    {step.step}
                  </span>
                ...
                <h3 className="text-base font-bold font-mono text-slate-950 tracking-tight">
                  {step.title}
                </h3>
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 flex items-center gap-1.5 text-[11px] font-mono font-bold text-brand-orange-600">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-4 space-y-5">
              <div className="w-14 h-14 rounded-2xl bg-brand-orange-50 text-brand-orange-600 flex items-center justify-center border border-brand-orange-200 shadow-orange-sm">
              ...
              <div className="space-y-2.5 pt-2 font-mono text-xs text-slate-700">
            ...
            <div className="lg:col-span-8 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-slate-50 border border-slate-200 p-5 rounded-2xl">
                  <div className="flex items-center gap-2.5 mb-3 text-brand-orange-600">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                <h4 className="text-xs font-mono font-bold uppercase tracking-widest text-brand-orange-600 mb-3">
